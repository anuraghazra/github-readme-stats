<!-- 
This project translated to Indonesian by FajarKim.
Follow me on GitHub: https://github.com/FajarKim

Donate: 
  - Paypal: https://paypal.me/agusbirawan
  - Trakteer: https://trakteer.id/FajarKim
  - Buy Me a Coffee: https://buymeacoffee.com/FajarKim

Do you need an Indonesian translator?  Feel free to contact me.
Thank you!!
-->
<p align="center">
...
- [Lakukan deploy sendiri](#lakukan-deploy-sendiri)
  - [Di Vercel](#di-vercel)
    - [:film\_projector: Lihat Tutorial Video Langkah Demi Langkah Oleh @codeSTACKr](#film_projector-lihat-tutorial-video-langkah-demi-langkah-oleh-codestackr)
...
# Pemberitahuan Penting <!-- omit in toc -->
...
<details>
<summary>:eyes: Lihat contoh</summary>
...
Pin Ekstra GitHub memungkinkan Anda untuk meng-pin lebih dari enam repositori di profil GitHub Anda menggunakan GitHub readme profile.
...
Anda dapat menggunakan opsi `&layout=compact` untuk mengubah desain kartu.
...
*   Tata letak Grafik Donut Vertical
...
<details>
 <summary><b>:hammer_and_wrench: Berikut ini adalah panduan langkah demi langkah untuk mengatur instansi Vercel Anda sendiri:</b></summary>

1.  Pergi ke [vercel.com](https://vercel.com/).
2.  Klik `Log in`.
    ![](https://files.catbox.moe/pcxk33.png)
3.  Masuk dengan GitHub dengan menekan tombol `Continue with GitHub`.
    ![](https://files.catbox.moe/b9oxey.png)
4.  Masuk ke GitHub dan izinkan akses ke semua repositori jika diminta.
5.  Fork repositori ini.
6.  Kembali ke [dasbor Vercel](https://vercel.com/dashboard).
7.  Untuk mengimpor sebuah proyek, klik tombol `Add New...` dan pilih opsi `Project`.
    ![](https://files.catbox.moe/3n76fh.png)
8.  Klik tombol `Continue with GitHub`, cari Repositori Git yang diperlukan, dan impor dengan mengklik tombol `Import`. Sebagai alternatif, Anda dapat mengimpor Repositori Git Pihak Ketiga menggunakan tautan `Import Third-Party Git Repository ->` di bagian bawah halaman.
    ![](https://files.catbox.moe/mg5p04.png)
9.  Buat personal access token (PAT) [di sini](https://github.com/settings/tokens/new) dan aktifkan izin `repo` dan `user` (ini memungkinkan akses untuk melihat statistik repositori dan pengguna pribadi).
10. Tambahkan PAT sebagai variabel lingkungan dengan nama `PAT_1` (seperti yang ditunjukkan).
    ![](https://files.catbox.moe/0yclio.png)
11. Klik deploy, dan Anda siap untuk melanjutkan. Lihat domain Anda untuk menggunakan API!
...
<details>
<summary><b>:hammer_and_wrench: Berikut ini adalah panduan langkah demi langkah untuk melakukan deploy di platform lain:</b></summary>

1.  Fork atau clone repositori ini sesuai dengan kebutuhan Anda.
2.  Tambahkan `express` ke bagian dependensi dalam `package.json`.
    <https://github.com/anuraghazra/github-readme-stats/blob/ba7c2f8b55eac8452e479c8bd38b044d204d0424/package.json#L54-L61>
3.  Jalankan `npm i` jika diperlukan (pemasangan awal).
4.  Jalankan `node express.js` untuk memulai server, atau atur titik masuk ke `express.js` dalam `package.json` jika Anda sedang mendeploy di layanan yang dikelola.
