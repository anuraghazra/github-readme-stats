...
<details>
 <summary><b>:hammer_and_wrench: Poradnik krok po kroku jak ustawić swoją własną instancję na Vercelu</b></summary>

1.  Przejdź na [vercel.com](https://vercel.com/).
2.  Kliknij `Log in`.
    ![](https://files.catbox.moe/pcxk33.png)
3.  Zaloguj się przy użyciu GitHuba klikając `Continue with GitHub`.
    ![](https://files.catbox.moe/b9oxey.png)
4.  Zaloguj się na GitHuba i udziel zgody dla wszystkich repozytoriów jeżeli takowe będą.
5.  Udostępnij to repozytorium na swoim profilu GitHub (Fork).
6.  Po udostępnieniu repozytorium, otwórz plik [`vercel.json`](https://github.com/anuraghazra/github-readme-stats/blob/master/vercel.json#L5) i zmień pole `maxDuration` na `10`.
7.  Wróć do [strony zarządzania Vercela](https://vercel.com/dashboard).
8.  Żeby zaimportować projekt, kliknij przycisk `Add New...` i wybierz opcje `Project`.
    ![](https://files.catbox.moe/3n76fh.png)
9.  Kliknij przycisk `Continue with GitHub`, poszukaj wymaganego repozytorium i zaimportuj je klikając przycisk `Import`. Alternatywnie, możesz zaimportować zewnętrzne repozytorium z GitHuba używjąc linku `Import Third-Party Git Repository ->` który znajduje się na dole strony.
    ![](https://files.catbox.moe/mg5p04.png)
10. Stwórz swój personalny token dostępu (PAT) [tutaj](https://github.com/settings/tokens/new) i zaznacz `repo` (to pozwala na dostęp do statystyk prywatnych repozytoriów).
11. Dodaj twój PAT jako zmienną środowiskową o nazwie `PAT_1` (jak pokazano).
    ![](https://files.catbox.moe/0yclio.png)
12. Naciśnij `deploy`, i to wszystko. Zobacz swoje domeny, aby skorzystać z API!
