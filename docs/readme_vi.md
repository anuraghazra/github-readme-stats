...
<details>
 <summary><b> Hướng dẫn cài đặt Vercel  🔨 </b></summary>

1. Đi đến [vercel.com](https://vercel.com/)
2. Nhấn vào `Log in`
   ![](https://files.catbox.moe/tct1wg.png)
3. Nhấn `Continue with GitHub` để đăng nhập bằng GitHub
   ![](https://files.catbox.moe/btd78j.jpeg)
4. Đăng nhập vào GitHub và cấp quyền nếu được hỏi
5. Fork repo này
6. Trở lại [Vercel dashboard](https://vercel.com/dashboard) của bạn
7. Chọn `Import Project`
   ![](https://files.catbox.moe/qckos0.png)
8. Chọn `Import Git Repository`
   ![](https://files.catbox.moe/pqub9q.png)
10. Chọn root và giữ nguyên mọi thứ, chỉ thêm environment variable của bạn đặt tên là PAT_1 (như hiển thị) sẽ chứa mã thông báo truy cập cá nhân (PAT), 
bạn có thể dễ dàng tạo [tại đây](https://github.com/settings/tokens/new) (để nguyên mọi thứ, chỉ đổi tên, nó có thể là bất cứ tên gì bạn muốn)
    ![](https://files.catbox.moe/0ez4g7.png)
11. Nhấn deploy, vậy là xong. Kiểm tra domain của bạn để sử dụng API!

</details>

## :sparkling_heart: Hỗ trợ dự án
