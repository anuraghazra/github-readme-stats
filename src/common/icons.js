...
const icons = {
  ...
  followers: `<path fill-rule="evenodd" d="M5.5 3.5a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-4 8a4 4 0 0 1 8 0v.5a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-.5Zm9.883-3.25a.75.75 0 0 1 .117 1.056 7.49 7.49 0 0 1-.324 1.106 3.001 3.001 0 0 1 2.324 2.838v.25a.75.75 0 0 1-1.5 0v-.25a1.5 1.5 0 0 0-1.078-1.414 8.966 8.966 0 0 1-.497-1.708.75.75 0 0 1 1.056-.622ZM12 3.5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/>`,
  repos: `<path fill-rule="evenodd" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8z"/>`,
};
