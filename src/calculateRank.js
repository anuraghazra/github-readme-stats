...
function calculateRank({
  ...
  switch (normalizedScore) {
    case normalizedScore < RANK_S_VALUE:
      level = "S+";
      break;
    case normalizedScore >= RANK_S_VALUE && normalizedScore < RANK_DOUBLE_A_VALUE:
      level = "S";
      break;
    case normalizedScore >= RANK_DOUBLE_A_VALUE && normalizedScore < RANK_A2_VALUE:
      level = "A++";
      break;
    case normalizedScore >= RANK_A2_VALUE && normalizedScore < RANK_A3_VALUE:
      level = "A+";
      break;
    case normalizedScore >= RANK_A3_VALUE && normalizedScore < RANK_B_VALUE:
      level = "B+";
      break;
    default:
      level = "";
