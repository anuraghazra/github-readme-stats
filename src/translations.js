...
const streakCardLocales = ({ user_name, apostrophe }) => {
  const encodedName = encodeHTML(user_name);
  return {
    "streakcard.title": {
      ar: `${encodedName} احصائيات الخط`,
      cn: `${encodedName} 连胜统计`,
      "zh-tw": `${encodedName} 連勝統計`,
      cs: ` ${encodedName} statistiky pruhů`,
      de: `${encodedName + apostrophe} Streak-Statistiken`,
      en: `${encodedName}'${apostrophe} Streak Stats`,
      es: `estadísticas de racha de ${encodedName}`,
      fr: `statistiques de séquence de ${encodedName}`,
      hu: `${encodedName} sorozat statisztika`,
      it: `statistiche delle serie consecutive di ${encodedName}`,
      ja: `${encodedName} 連続統計`,
      nl: `${encodedName}'${apostrophe} streak-statistieken`,
      "pt-pt": `Estatísticas de sequência de ${encodedName}`,
      "pt-br": `Estatísticas de sequência de ${encodedName}`,
      el: `στατιστικά σερί του ${encodedName}`,
      ru: `статистика полос ${encodedName}`,
      id: `statistik beruntun ${encodedName}`,
      ml: `${encodedName}'${apostrophe} സ്ട്രീക്ക് സ്ഥിതിവിവരക്കണക്കുകൾ`,
      sk: `štatistiky série ${encodedName}`,
      tr: `${encodedName} galibiyet serisi istatistikleri`,
      pl: `statystyki serii ${encodedName}`,
      vi: `số liệu thống kê liên tục ${encodedName}`,
    },

    "streakcard.totalcontributions": {
      ar: "إجمالي المساهمات",
      cn: "捐款总额",
      "zh-tw": "捐款總額",
      cs: "celkové příspěvky",
      de: "Gesamtbeiträge",
      en: "Total contributions",
      es: "contribuciones totales",
      fr: "cotisations totales",
      hu: "teljes hozzájárulás",
      it: "contributi totali",
      ja: "寄付総額",
      nl: "totale bijdragen",
      "pt-pt": "contribuições totais",
      "pt-br": "contribuições totais",
      el: "συνολικές εισφορές",
      ru: "общая сумма взносов",
      id: "total kontribusi",
      ml: "മൊത്തം സംഭാവനകൾ",
      sk: "celkové príspevky",
      tr: "toplam katkılar",
      pl: "całkowite składki",
      vi: "tổng đóng góp",
    },
    ...
    "streakcard.longest": {
      ...
      en: "Longest Streak",
      es: "Racha más larga",
      fr: "La plus longue série",
      hu: "leghosszabb sorozata",
      it: "serie più lunga",
      ja: "最長連続記録",
      nl: "langste reeks",
      ...
      id: "pukulan terpanjang",
      ml: "ഏറ്റവും ദൈർഘ്യമേറിയ സ്ട്രീക്ക്",
      sk: "najdlhšia séria",
      tr: "en uzun seri",
      pl: "najdłuższa passa",
      vi: "chuỗi dài nhất",
