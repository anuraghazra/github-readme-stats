...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      ksw: `Github Stats za ${encodedName}`,
    ...
    "statcard.ranktitle": {
      ...
      cs: `GitHub statistiky uživatele ${encodedName}`,
      de: `${encodedName + apostrophe} GitHub-Statistiken`,
      ksw: `Github Rank ya ${encodedName}`,
    ...
    "statcard.totalstars": {
      ...
      ksw: "Medali(stars) ulizojishindia",
    ...
    "statcard.contribs": {
      ...
      ksw: "Idadi ya michango (mwaka mzima)",
    ...
    "statcard.reviews": {
      ...
      ksw: "Idadi ya PRs zilizopitiliwa upya",
    ...
    "statcard.discussions-started": {
      ...
      ksw: "Idadi ya majadiliano yaliyoanzishwa",
    ...
    "statcard.discussions-answered": {
      ...
      ksw: "Idadi ya majadiliano yaliyojibiwa",
    ...
    "statcard.prs-merged": {
      ...
      ksw: "Idadi ya PRs zilizounganishwa",
      ur: "کل پی آرز ضم کیے",
    ...
    "statcard.prs-merged-percentage": {
      ...
      ksw: "Asilimia ya PRs zilizounganishwa",
...
const repoCardLocales = {
  ...
  "repocard.archived": {
    ...
    cs: "Archivováno",
    de: "Archiviert",
    ksw: "Hifadhiwa kwenye kumbukumbu",
    ur: "محفوظ شدہ",
    es: "Archivados",
    fa: "بایگانی‌شده",
    fi: "Arkistoitu",
...
const langCardLocales = {
  ...
  "langcard.nodata": {
    ...
    ksw: "Hakuna kumbukumbu ya lugha zozote",
...
const wakatimeCardLocales = {
  ...
  "wakatimecard.notpublic": {
    ...
    ksw: "Maelezo ya mtumizi wa WakaTime si ya watu wote(umma)",
  ...
  "wakatimecard.nocodedetails": {
    ...
    ksw: "Mtumizi hagawi kila kitu au takwimu na umma",
  ...
  "wakatimecard.nocodingactivity": {
    ...
    ksw: "Hakuna matukio yoyote ya kusimba wiki hii",
