...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      ro: `Statisticile GitHub pentru ${encodedName}`,
...
const wakatimeCardLocales = {
  ...
  "wakatimecard.notpublic": {
    ...
    ro: "Profilul WakaTime nu este public",
  ...
  "wakatimecard.nocodedetails": {
    ...
    ro: "Utilizatorul nu face publice statistici detaliate ale codului",
  ...
  "wakatimecard.nocodingactivity": {
    ...
    ro: "Nu are activitate de programare in această săptămână",
