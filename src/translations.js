...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    ...
    "statcard.contribs-alltime": {
      ...
      cn: "贡献的项目数（全部时间）",
      "zh-tw": "參與項目數量（全部時間）",
      cs: "Přispěl k (celá doba)",
      de: "Beigetragen zu (gesamte Zeit)",
      sw: "Idadi ya michango (wakati wote)",
      ur: "تمام وقت میں تعاون کیا",
      bg: "Приноси (за цялото време)",
      bn: "অবদান (সব সময়)",
      es: "Contribuciones en (todo el tiempo)",
      fa: "مشارکت در (تمام زمان‌ها)",
      fi: "Osallistunut (koko ajan)",
      fr: "Contribué à (tout le temps)",
      hi: "(सभी समय) में योगदान दिया",
      sa: "(सर्वदा) योगदानम् कृतम्",
      hu: "Hozzájárulások (minden idők)",
      it: "Ha contribuito a (sempre)",
      ja: "貢献したリポジトリ （全期間）",
      kr: "(전체 기간) 기여",
      nl: "Bijgedragen aan (alle tijd)",
      "pt-pt": "Contribuiu em (todo o tempo)",
      "pt-br": "Contribuiu para (todo o tempo)",
      np: "कुल योगदानहरू (सबै समय)",
      el: "Συνεισφέρθηκε σε (όλη την ώρα)",
      ro: "Total Contribuiri (tot timpul)",
      ru: "Внесено вклада (за все время)",
      "uk-ua": "Зроблено внесок (за весь час)",
      id: "Berkontribusi ke (sepanjang waktu)",
      ml: "(എല്ലാ സമയത്തും)ആകെ സംഭാവനകൾ",
      my: "အကူအညီပေးခဲ့သည် (အချိန်တိုင်း)",
      ta: "(எல்லா காலமும்) பங்களித்தது",
      sk: "Účasti (celý čas)",
      tr: "Katkı Verildi (tüm zamanlar)",
      pl: "Kontrybucje (cały czas)",
      uz: "Hissa qoʻshgan (barcha vaqt)",
      vi: "Đã Đóng Góp (mọi lúc)",
      se: "Bidragit till (all tid)",
      he: "תרם ל... (כל הזמן)",
      fil: "Nag-ambag sa (buong panahon)",
      th: "มีส่วนร่วมใน (ตลอดเวลา)",
      sr: "Доприноси (све време)",
      "sr-latn": "Doprinosi (sve vreme)",
      no: "Bidro til (hele tiden)",
    },
    "statcard.reviews": {
