...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      ua: `Статистика GitHub користувача ${encodedName}`,
    ...
    "statcard.prs": {
      ...
      ua: "Всього pull request`ів",
      "uk-ua": "Всього pull request`ів",
...
const langCardLocales = {
  "langcard.title": {
    ...
    ua: "Найбільш часто використовувані мови",
...
const wakatimeCardLocales = {
  ...
  "wakatimecard.nocodingactivity": {
    ...
    ua: "На цьому тижні не було активності",
