...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    ...
    "statcard.totalstars": {
      ...
      ml: "ആകെ നക്ഷത്രങ്ങൾ",
      my: "Jumlah Bintang",
      ta: `${encodedName} சம்பாதித்த மொத்த நட்சத்திரங்கள்`,
      sk: "Hviezdy",
      tr: "Toplam Yıldız",
    ...
    "statcard.contribs": {
      ...
      ta: `${encodedName} (கடந்த ஆண்டு) பங்களித்தது`,
    ...
    "statcard.reviews": {
      ...
      ta: `${encodedName} மதிப்பாய்வு செய்யப்பட்ட மொத்த இழுத்தல் கோரிக்கைகள்`,
      sk: "Celkový počet PR",
    ...
    "statcard.discussions-started": {
      ...
      ta: `${encodedName}மொத்த விவாதங்கள் தொடங்கின`,
    ...
    "statcard.discussions-answered": {
      ...
      ta: `${encodedName} பதிலளிக்கப்பட்ட மொத்த விவாதங்கள்`,
    ...
    "statcard.prs-merged": {
      ...
      ta: `${encodedName} இணைக்கப்பட்ட மொத்த PRகள்`,
    ...
    "statcard.prs-merged-percentage": {
      ...
      ta: `${encodedName} இணைக்கப்பட்ட PRகள் சதவீதம்`,
