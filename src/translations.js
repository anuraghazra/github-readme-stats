...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      hi: '${encodedName} की गिटहब सांख्यिकी',
    ...
    "statcard.totalstars": {
      ...
      fr: "Total d'étoiles",
      hi: 'अर्जित सितारों की कुल संख्या',
      hu: "Csillagok",
      it: "Stelle totali",
      ja: "スターされた数",
      kr: "받은 스타 수",
