...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      ml: `${encodedName}'$ ഗിറ്റ്ഹബ് സ്ഥിതിവിവരക്കണക്കുകൾ`,
