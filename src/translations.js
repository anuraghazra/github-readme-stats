...
const langCardLocales = {
  ...
  "langcard.nodata": {
    ...
    de: "",
    bn: "",
    en: "No languages data, looks like you don't have any public repositories.",
    es: "",
    fr: "",
    hu: "",
    it: "",
    ...
    np: "",
    el: "",
    ru: "Нет данных о языках, похоже, у вас нет общедоступных репозиториев.",
    "uk-ua":
      "Немає даних про мови, схоже, у вас немає загальнодоступних сховищ.",
    id: "",
    ml: "",
    my: "",
    sk: "",
    tr: "",
    pl: "Brak danych językowych, wygląda na to, że nie masz żadnych publicznych repozytoriów.",
    vi: "",
    se: "",
  },
};
