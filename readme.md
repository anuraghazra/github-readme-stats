...
*   `description_lines_count` - Manually set the number of lines for the description *(number)*. If this parameter is not specified, the number of lines will be automatically adjusted according to the length of the description.
